local BLOCKS = require(game.ReplicatedStorage.LocalModules.BlocksID)
		local classicInventory = {
			...
			BLOCKS.BLOCK_GOLD_ORE, BLOCKS.BLOCK_IRON, BLOCKS.BLOCK_GOLD, BLOCKS.BLOCK_BOOKSHELF, BLOCKS.BLOCK_TNT, BLOCKS.BLOCK_OBSIDIAN, BLOCKS.STATIONARY_WATER, BLOCKS.STATIONARY_LAVA
		}
